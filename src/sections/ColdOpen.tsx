  ...
  return (
    ...
    >
      {/* fallback: sem 3D, o disco de fundo é este SVG; com 3D, o herói
          assume EXATAMENTE esta estação (mesmo centro, diâmetro e opacidade
          — ver COLD em src/lib/heroStore.ts) e o crossfade é invisível */}
      <div
        data-fx="disc"
        className="vinyl-fallback pointer-events-none absolute top-1/2 left-1/2 w-[131svh] -translate-x-1/2 -translate-y-1/2 opacity-20 blur-[2px]"
      >
